SubtleAttentionSeekerDemo
=========================

[Cyril Mottier][0]'s "subtle attention seeker" Android view animation ported to NineOldAndroids extending the compatibility down to API 8.
